...
class Model(nn.Module):
    ...
    def __init__(self, configs):
        ...
        # channel clustering cannot use more clusters than channels (matters for
        # univariate / few-variable series such as realized volatility)
        self.n_clusters = min(configs.n_clusters, configs.enc_in)
        ...
        self.trend_linear = ClusteredLinear(self.n_clusters, configs.enc_in, self.seq_len, configs.pred_len)
        # Embedding
